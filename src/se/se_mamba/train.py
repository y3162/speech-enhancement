...
def validate(
    ...
    for clean_audio, noisy_audio, lengths in loader:
        ...
        losses = generator_loss(clean, clean_audio, gen, enhanced_audio, gen_hat, metric_g, cfg.train.loss, stft.n_fft)
...
def main() -> None:
    ...
    for epoch in range(start_epoch, cfg.train.epochs):
        ...
        for clean_audio, noisy_audio in train_loader:
            ...
            metric_g = discriminator(clean.mag, gen.mag)
            losses = generator_loss(clean, clean_audio, gen, enhanced_audio, gen_hat, metric_g, weights, stft.n_fft)
